...
export default function Contracts({ contracts, columns, actions=[] }) {
  ...
  columns = columns ? columns : (config.isLocalDev ? [ [ "Module", "templateId.moduleName" ], [ "Template", "templateId.entityName" ], [ "ContractId", "contractId" ] ] : [[ "Template", "templateId" ], [ "ContractId", "contractId" ] ]);
